...
const App: React.FC = () => {
  ...
  // Dual purpose input depending on calcType
  // If Contribution Type: this is Period (years/months)
  // If Time Type: this is Monthly Contribution value
  ...
  const renderCharts = (data: CalculationResult) => {
    ...
    // Updated COLORS to match new Cyan Theme (Brand-700 = #0e7490)
    const COLORS = ['#64748b', '#0e7490']; // Slate-500, Cyan-700
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 flex flex-col items-center">
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                />
                {/* Removed Recharts default legend to use custom one */}
              </PieChart>
            </ResponsiveContainer>
          </div>
          <div className="w-full mt-4 space-y-3">
            ...
            {/* Changed from bg-red-50 to bg-brand-50 to match theme */}
          ...
          <div className="h-80 w-full text-xs">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                {/* Updated stroke colors to match new Cyan theme (#0e7490) */}
    ...
    <div className="relative">
      <select 
        ...
        onChange={(e) => {
          ...
          // Set nice defaults when switching
  ...
  const renderInputFields = () => {
    // Inputs defined as JSX elements to preserve focus on re-renders
      ...
      <div>
        ...
        <div className="flex rounded-lg shadow-sm">
          ...
          <select
            ...
            className="rounded-r-lg border border-l-0 border-slate-200 bg-white px-4 py-3 text-slate-600 text-sm hover:bg-slate-50 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-colors"
          >
    ...
    // Render Layout Logic
    if (calcType === CalculationType.CONTRIBUTION) {
      return (
